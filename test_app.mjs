...
const plantelOptions = await page.locator('select[name="plantelId"] option').count();
console.log("plantel options:", plantelOptions);
await page.selectOption('select[name="plantelId"]', { index: 1 });
